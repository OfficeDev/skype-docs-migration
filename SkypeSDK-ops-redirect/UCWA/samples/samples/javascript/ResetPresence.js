...
(function() {
    ...
    function handleResetPresence(data) {
        if (data.status === 204 && data.statusText === "success") {
            alert("Status has reset, but you won't see it until you get it again!");
        }
    }

    $("#resetPresence").click(function() {
        ucwa.Cache.read({
            id: "main"
